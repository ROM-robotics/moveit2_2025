...
class Controller(Node):
    ...
    def __init__(self):
        ...
        self.panda_arm = self.panda.get_planning_component("ur5_manipulator")
        self.panda_hand = self.panda.get_planning_component("robotiq_gripper")
    ...
    def move_to(self, x, y, z, xo, yo, zo, wo):
        ...
        self.panda_arm.set_goal_state(pose_stamped_msg = self.pose_goal, pose_link="tool0")
    ...
    def gripper_action(self, action):
        ...
        joint_constraint = construct_joint_constraint(
            ...
            joint_model_group = self.panda.get_robot_model().get_joint_model_group("ur5_manipulator"),
        )        
