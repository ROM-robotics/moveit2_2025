...
public:
    Controller() : Node("arm_controller_from_ui")
    {
        ...
        pick_height_ = 0.126;   // 12.6 cm from base_link to tool0 link, for picking bolt
    }
    ...
    void gripper_action(const std::string& action)
{
    ...
    void listener_callback(const std_msgs::msg::Float64MultiArray::SharedPtr msg)
    {
        ...
        move_to(msg->data[0], msg->data[1], pick_height_, final_ros_orientation.x, final_ros_orientation.y, final_ros_orientation.z, final_ros_orientation.w);
